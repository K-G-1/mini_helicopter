...
/////////////////////////////////////////////////////////////////////////////////////
//Data_Exchange????????????,??????6ms?????????????,????????(cnt = 6/2 = 3)
//????????2ms????
void ANO_DT_Data_Exchange(void) //2ms??
{
	static u8 cnt = 0;
...
//		ANO_DT_Send_Version(1,ANO_Param.hardware,ANO_Param.software,400,0);
	...
	{
		f.send_senser = 0;
		ANO_DT_Send_Senser(g_t_Accel_CMS.X,g_t_Accel_CMS.Y,g_t_Accel_CMS.Z,g_t_Gyro_CMS.X,g_t_Gyro_CMS.Y,g_t_Gyro_CMS.Z,
												0,0,0);
	}	
	else if(f.send_pid1)
	{
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_pid2 = 0;
		ANO_DT_Send_PID(2,ANO_Param.PID_rol.kp,ANO_Param.PID_rol.ki,0,
						  ANO_Param.PID_pit.kp,ANO_Param.PID_pit.ki,0,
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_motopwm = 0;
					pwm1=(g_u16_Pwm1MC_CMS*1.0/3600)*1000;
					pwm2=(g_u16_Pwm2MC_CMS*1.0/3600)*1000;
					pwm3=(g_u16_Pwm3MC_CMS*1.0/3600)*1000;
					pwm4=(g_u16_Pwm4MC_CMS*1.0/3600)*1000;
		ANO_DT_Send_MotoPWM(pwm1,pwm2,pwm3,pwm4,0,0,0,0);
	}		
	else if(f.send_rcdata)
	{
		f.send_rcdata = 0;
		ANO_DT_Send_RCData(g_t_Rc_D_CMS.THROTTLE,g_t_Rc_D_CMS.YAW,g_t_Rc_D_CMS.ROLL,g_t_Rc_D_CMS.PITCH,0,0,0,0,0,0);
	}		
	else if(f.send_status)
	{
		f.send_status = 0;
		ANO_DT_Send_Status(g_t_AttAngle_CMS.rol,g_t_AttAngle_CMS.pit,g_t_AttAngle_CMS.yaw,0,0,g_t_Rc_C_CMS.ARMED);	
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
//		RX_CH[AUX4] = (vs16)(*(data_buf+18)<<8)|*(data_buf+19) ;
    ...
    if(*(data_buf+2)==0X11)								//PID2
    {
       ...
       ANO_Param.PID_yaw.kp 	= 0;
       ANO_Param.PID_yaw.ki 	= 0;
       ANO_Param.PID_yaw.kd 	= 0;

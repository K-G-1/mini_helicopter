...
void ANO_DT_Data_Receive_Anl(uint8_t *data_buf,uint8_t num)
{
    ...
    {
        PID_ROL_Rate.P = 0.001*( (int16_t)(*(data_buf+4)<<8)|*(data_buf+5) );
        PID_ROL_Rate.I = 0.001*( (int16_t)(*(data_buf+6)<<8)|*(data_buf+7) );
        PID_ROL_Rate.D = 0.001*( (int16_t)(*(data_buf+8)<<8)|*(data_buf+9) );
        PID_PIT_Rate.P = 0.001*( (int16_t)(*(data_buf+10)<<8)|*(data_buf+11) );
        PID_PIT_Rate.I = 0.001*( (int16_t)(*(data_buf+12)<<8)|*(data_buf+13) );
        PID_PIT_Rate.D = 0.001*( (int16_t)(*(data_buf+14)<<8)|*(data_buf+15) );
        PID_YAW_Rate.P = 0.001*( (int16_t)(*(data_buf+16)<<8)|*(data_buf+17) );
        PID_YAW_Rate.I = 0.001*( (int16_t)(*(data_buf+18)<<8)|*(data_buf+19) );
        PID_YAW_Rate.D = 0.001*( (int16_t)(*(data_buf+20)<<8)|*(data_buf+21) );
        ANO_DT_Send_Check(*(data_buf+2),sum);
		PID_WriteFlash();
    }
    if(*(data_buf+2)==0X11)								//PID2
    {
        PID_ROL_Angle.P 	= 0.001*( (int16_t)(*(data_buf+4)<<8)|*(data_buf+5) );
        PID_ROL_Angle.I 	= 0.001*( (int16_t)(*(data_buf+6)<<8)|*(data_buf+7) );
        PID_ROL_Angle.D 	= 0.001*( (int16_t)(*(data_buf+8)<<8)|*(data_buf+9) );
        PID_PIT_Angle.P 	= 0.001*( (int16_t)(*(data_buf+10)<<8)|*(data_buf+11) );
        PID_PIT_Angle.I 	= 0.001*( (int16_t)(*(data_buf+12)<<8)|*(data_buf+13) );
        PID_PIT_Angle.D 	= 0.001*( (int16_t)(*(data_buf+14)<<8)|*(data_buf+15) );
        PID_YAW_Angle.P	  = 0.001*( (int16_t)(*(data_buf+16)<<8)|*(data_buf+17) );
        PID_YAW_Angle.I 	= 0.001*( (int16_t)(*(data_buf+18)<<8)|*(data_buf+19) );
        PID_YAW_Angle.D 	= 0.001*( (int16_t)(*(data_buf+20)<<8)|*(data_buf+21) );
  ...
  {	
		PID_ALT_Rate.P 	= 0.001*( (int16_t)(*(data_buf+4)<<8)|*(data_buf+5) );
		PID_ALT_Rate.I 	= 0.001*( (int16_t)(*(data_buf+6)<<8)|*(data_buf+7) );
		PID_ALT_Rate.D 	= 0.001*( (int16_t)(*(data_buf+8)<<8)|*(data_buf+9) );
		PID_ALT.P 	= 0.001*( (int16_t)(*(data_buf+10)<<8)|*(data_buf+11) );
		PID_ALT.I 	= 0.001*( (int16_t)(*(data_buf+12)<<8)|*(data_buf+13) );
		PID_ALT.D 	= 0.001*( (int16_t)(*(data_buf+14)<<8)|*(data_buf+15) );
//		PID_ALT.P	  = 0.001*( (int16_t)(*(data_buf+16)<<8)|*(data_buf+17) );
//		PID_ALT.I 	= 0.001*( (int16_t)(*(data_buf+18)<<8)|*(data_buf+19) );
//		PID_ALT.D 	= 0.001*( (int16_t)(*(data_buf+20)<<8)|*(data_buf+21) );
		ANO_DT_Send_Check(*(data_buf+2),sum);
		PID_WriteFlash();
  }

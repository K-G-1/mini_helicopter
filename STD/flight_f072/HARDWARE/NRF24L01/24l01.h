...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//24L01操作线
#define NRF24L01_CE_L    GPIO_ResetBits(GPIOA,GPIO_Pin_4);			 //24L01片选信号
#define NRF24L01_CE_H    GPIO_SetBits(GPIOA,GPIO_Pin_4);			 //24L01片选信号
#define NRF24L01_CSN_L   GPIO_ResetBits(GPIOA,GPIO_Pin_1); //SPI片选信号	   
#define NRF24L01_CSN_H   GPIO_SetBits(GPIOA,GPIO_Pin_1); //SPI片选信号	 
#define NRF24L01_IRQ   GPIO_ReadInputDataBit(GPIOA,GPIO_Pin_0)  //IRQ主机数据输入
//24L01发送接收数据宽度定义

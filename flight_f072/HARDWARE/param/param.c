...
{
    STMFLASH_Write(save_gyro_x,&sensor.gyro.quiet.x,1);
	STMFLASH_Write(save_gyro_y,&sensor.gyro.quiet.y,1);
    STMFLASH_Write(save_gyro_z,&sensor.gyro.quiet.z,1);
    
    STMFLASH_Write(save_acc_x,&sensor.acc.quiet.x,1);
	STMFLASH_Write(save_acc_y,&sensor.acc.quiet.y,1);
    STMFLASH_Write(save_acc_z,&sensor.acc.quiet.z,1);
}
...
{
    STMFLASH_Read(save_gyro_x,&sensor.gyro.quiet.x,1);
	STMFLASH_Read(save_gyro_y,&sensor.gyro.quiet.y,1);
    STMFLASH_Read(save_gyro_z,&sensor.gyro.quiet.z,1);
    
    STMFLASH_Read(save_acc_x,&sensor.acc.quiet.x,1);
	STMFLASH_Read(save_acc_y,&sensor.acc.quiet.y,1);
    STMFLASH_Read(save_acc_z,&sensor.acc.quiet.z,1);
